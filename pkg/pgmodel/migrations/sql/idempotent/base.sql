...
CREATE OR REPLACE FUNCTION SCHEMA_CATALOG.mark_unused_ids(
...
CREATE OR REPLACE FUNCTION SCHEMA_CATALOG.clear_old_ids(
...
BEGIN
    ...
    IF older_than IS NULL THEN
        ...
        PERFORM SCHEMA_CATALOG.clear_old_ids(metric_table, ran_at);
        RETURN;
    END IF;

    -- transaction 2
        PERFORM SCHEMA_CATALOG.mark_unused_ids(metric_table, older_than, check_time);
    COMMIT;
